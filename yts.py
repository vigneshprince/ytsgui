...
def main():
    ...
    try:
        r = requests.get('https://yts.mx/browse-movies', timeout=7)
        ...
        while True and page < movie_count / 50:
            ...
            r = requests.get(
                'https://yts.mx/api/v2/list_movies.json', params=payload)
            ...
            if(flag == 0):
                ...
                r = requests.get(
                    'https://yts.mx/api/v2/movie_details.json', params=payload)
                r_new_dict = r.json()
                print("\n")
